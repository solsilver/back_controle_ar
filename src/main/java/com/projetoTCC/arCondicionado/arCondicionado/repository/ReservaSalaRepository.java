...
public interface ReservaSalaRepository extends JpaRepository<ReservaSala, Long> {
    ...
    ReservaSala findAtiva(@Param("salaId") Long salaId, @Param("diaSemana") DayOfWeek diaSemana, @Param("hora") LocalTime hora);
    ...
    boolean existsBySalaAndDiaSemanaAndHorarioInicio(Sala sala, DayOfWeek hoje, LocalTime horaAtual);
}
